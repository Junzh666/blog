import{_ as r}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as i,o as p,c as u,e as l,w as e,b as n,d as s,f as d}from"./app-5PTYiyns.js";const k={},m=n("h2",{id:"创建容器所需的文件",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#创建容器所需的文件","aria-hidden":"true"},"#"),s(" 创建容器所需的文件")],-1),v=n("p",null,[n("code",null,"vim db.env")],-1),b=n("div",{class:"language-env line-numbers-mode","data-ext":"env"},[n("pre",{class:"language-env"},[n("code",null,`MYSQL_PASSWORD=qwer1234
