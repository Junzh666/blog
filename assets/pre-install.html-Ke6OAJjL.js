import{_ as d}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as l,o as m,c as o,e as t,w as n,b as e,d as s,f as r}from"./app-fa1rd8Xh.js";const b={},p=r(`<div class="hint-container note"><p class="hint-container-title">注</p><p>大多数ISP会限制25端口（smtp），请与ISP沟通解除25端口限制，否则iRedmail将无法正常发送邮件。</p></div><h2 id="设置fqdn" tabindex="-1"><a class="header-anchor" href="#设置fqdn" aria-hidden="true">#</a> 设置FQDN</h2><p>编辑<code>/etc/hosts</code>文件，内容如下：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token number">127.0</span>.0.1 mail.mydomain.com sz-demo localhost localhost.localdomain
